...
1. Add ops ListDiff for bazel building to support TensorFlow mobile.

2. Add listdiff_op.cc, bitwise_ops.cc, and lookup_ops.cc for android aar building.

3. tensorflow/examples/android.zip based on the .so lib

4. tensorflow/examples/android new samples.
